...
void AutoTurn::Execute() {
	if(mClockwise)
	{
		...
		Robot::chassis->leftA->Set(-0.25 - angleError/mDesiredDegrees*kP);
		Robot::chassis->leftB->Set(-0.25 - angleError/mDesiredDegrees*kP);
		Robot::chassis->rightA->Set(-0.25 - angleError/mDesiredDegrees*kP);
		Robot::chassis->rightB->Set(-0.25 - angleError/mDesiredDegrees*kP);
	}
	else
	{
	...
	angleError = mDesiredDegrees - currentDegrees;
