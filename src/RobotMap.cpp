...
std::shared_ptr<SpeedController> RobotMap::shooterLFeed;
std::shared_ptr<SpeedController> RobotMap::shooterRShoot;
std::shared_ptr<SpeedController> RobotMap::shooterRFeed;
...
void RobotMap::init() {
    ...
    shooterRFeed.reset(new VictorSP(7));
    lw->AddActuator("Shooter", "RFeed", std::static_pointer_cast<VictorSP>(shooterRFeed));
